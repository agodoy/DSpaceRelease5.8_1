...
public class EPerson extends DSpaceObject
{
    ...
    /** Field sexo  (para almacenar) */
    public static final int SEXO = 6;

    /** field edad (para almacenar) */
    public static final int EDAD = 7;

    /** field EDUUCACION (para almacenar) */
    public static final int EDUCACION = 7;

    /** field OCUPACION (para almacenar) */
    public static final int OCUPACION = 8;

    /** field OTRAOCUPACION (para almacenar) */
    public static final int OTRAOCUPACION = 9;

    /** field ORGANIZACION (para almacenar) */
    public static final int ORGANIZACION = 10;

    /** field TIPOORGANIZACION (para almacenar) */
    public static final int TIPOORGANIZACION = 11;

    /** field OTROTIPOORGANIZACION (para almacenar) */
    public static final int OTROTIPOORGANIZACION = 12;

    /** field ACTIVIDADORGANIZACION (para almacenar) */
    public static final int ACTIVIDADORGANIZACION = 13;

    /** field OTRAACTIVIDADORGANIZACION (para almacenar) */
    public static final int OTRAACTIVIDADORGANIZACION = 14;

    /** field PAIS (para almacenar) */
    public static final int PAIS = 15;

    /** field ESTADO (para almacenar) */
    public static final int ESTADO = 16;

    /** field USOINFORMACION (para almacenar) */
    public static final int USOINFORMACION = 17;

    /** field OTROUSOINFORMACION (para almacenar) */
    public static final int OTROUSOINFORMACION = 18;
    ...
    /**
     * Get the eperson's SEXO.
     * @return their sexo
     */
    public String getSexo()
    {
        return myRow.getStringColumn("sexo");
    }

    /**
     * Set the eperson's sexo
     * @param sexo the person's sexo
     */
    public void setSexo(String sexo)
    {
        myRow.setColumn("sexo", sexo);
        modified = true;
    }

    /**
     * Get the eperson's edad.
     * @return their edad
     */
    public String getEdad()
    {
        return myRow.getStringColumn("edad");
    }

    /**
     * Set the eperson's edad
     * @param edad the person's edad
     */
    public void setEdad(String edad)
    {
        myRow.setColumn("edad", edad);
        modified = true;
    }

    /**
     * Get the eperson's educacion.
     * @return their educacion
     */
    public String getEducacion()
    {
        return myRow.getStringColumn("educacion");
    }

    /**
     * Set the eperson's educacion
     * @param educacion the person's educacion
     */
    public void setEducacion(String educacion)
    {
        myRow.setColumn("educacion", educacion);
        modified = true;
    }

    /**
     * Get the eperson's ocupacion.
     * @return their ocupacion
     */
    public String getOcupacion()
    {
        return myRow.getStringColumn("ocupacion");
    }

    /**
     * Set the eperson's ocupacion
     * @param ocupacion the person's ocupacion
     */
    public void setOcupacion(String ocupacion)
    {
        myRow.setColumn("ocupacion", ocupacion);
        modified = true;
    }

    /**
     * Get the eperson's otraocupacion.
     * @return their otraocupacion
     */
    public String getOtraocupacion()
    {
        return myRow.getStringColumn("otraocupacion");
    }

    /**
     * Set the eperson's otraocupacion
     * @param otraocupacion the person's otraocupacion
     */
    public void setOtraocupacion(String otraocupacion)
    {
        myRow.setColumn("otraocupacion", otraocupacion);
        modified = true;
    }

    /**
     * Get the eperson's organizacion.
     * @return their organizacion
     */
    public String getOrganizacion()
    {
        return myRow.getStringColumn("organizacion");
    }

    /**
     * Set the eperson's organizacion
     * @param organizacion the person's organizacion
     */
    public void setOrganizacion(String organizacion)
    {
        myRow.setColumn("organizacion", organizacion);
        modified = true;
    }

    /**
     * Get the eperson's tipoorganizacion.
     * @return their tipoorganizacion
     */
    public String getTipoorganizacion()
    {
        return myRow.getStringColumn("tipoorganizacion");
    }

    /**
     * Set the eperson's tipoorganizacion
     * @param tipoorganizacion the person's tipoorganizacion
     */
    public void setTipoorganizacion(String tipoorganizacion)
    {
        myRow.setColumn("tipoorganizacion", tipoorganizacion);
        modified = true;
    }

    /**
     * Get the eperson's otrotipoorganizacion.
     * @return their otrotipoorganizacion
     */
    public String getOtrotipoorganizacion()
    {
        return myRow.getStringColumn("otrotipoorganizacion");
    }

    /**
     * Set the eperson's otrotipoorganizacion
     * @param otrotipoorganizacion the person's otrotipoorganizacion
     */
    public void setOtrotipoorganizacion(String otrotipoorganizacion)
    {
        myRow.setColumn("otrotipoorganizacion", otrotipoorganizacion);
        modified = true;
    }

    /**
     * Get the eperson's actividadorganizacion.
     * @return their actividadorganizacion
     */
    public String getActividadorganizacion()
    {
        return myRow.getStringColumn("actividadorganizacion");
    }

    /**
     * Set the eperson's actividadorganizacion
     * @param actividadorganizacion the person's actividadorganizacion
     */
    public void setActividadorganizacion(String actividadorganizacion)
    {
        myRow.setColumn("actividadorganizacion", actividadorganizacion);
        modified = true;
    }

    /**
     * Get the eperson's otraactividadorganizacion.
     * @return their otraactividadorganizacion
     */
    public String getOtraactividadorganizacion()
    {
        return myRow.getStringColumn("otraactividadorganizacion");
    }

    /**
     * Set the eperson's otraactividadorganizacion
     * @param otraactividadorganizacion the person's otraactividadorganizacion
     */
    public void setOtraactividadorganizacion(String otraactividadorganizacion)
    {
        myRow.setColumn("otraactividadorganizacion", otraactividadorganizacion);
        modified = true;
    }

    /**
     * Get the eperson's pais.
     * @return their pais
     */
    public String getPais()
    {
        return myRow.getStringColumn("pais");
    }

    /**
     * Set the eperson's pais
     * @param pais the person's pais
     */
    public void setPais(String pais)
    {
        myRow.setColumn("pais", pais);
        modified = true;
    }

    /**
     * Get the eperson's estado.
     * @return their estado
     */
    public String getEstado()
    {
        return myRow.getStringColumn("estado");
    }

    /**
     * Set the eperson's estado
     * @param estado the person's estado
     */
    public void setEstado(String estado)
    {
        myRow.setColumn("estado", estado);
        modified = true;
    }

    /**
     * Get the eperson's usoinformacion.
     * @return their usoinformacion
     */
    public String getUsoinformacion()
    {
        return myRow.getStringColumn("usoinformacion");
    }

    /**
     * Set the eperson's usoinformacion
     * @param usoinformacion the person's usoinformacion
     */
    public void setUsoinformacion(String usoinformacion)
    {
        myRow.setColumn("usoinformacion", usoinformacion);
        modified = true;
    }

    /**
     * Get the eperson's otrousoinformacion.
     * @return their otrousoinformacion
     */
    public String getOtrousoinformacion()
    {
        return myRow.getStringColumn("otrousoinformacion");
    }

    /**
     * Set the eperson's otrousoinformacion
     * @param otrousoinformacion the person's otrousoinformacion
     */
    public void setOtrousoinformacion(String otrousoinformacion)
    {
        myRow.setColumn("otrousoinformacion", otrousoinformacion);
        modified = true;
    }
