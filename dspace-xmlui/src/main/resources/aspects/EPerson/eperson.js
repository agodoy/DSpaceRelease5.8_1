...
function updateInformation(eperson) 
{
    ...
    var sexo = cocoon.request.getParameter("sexo");
    var edad = cocoon.request.getParameter("edad");
    var educacion = cocoon.request.getParameter("educacion");
    var ocupacion = cocoon.request.getParameter("ocupacion");
    var otraocupacion = cocoon.request.getParameter("otraocupacion");
    var organizacion = cocoon.request.getParameter("organizacion");
    var tipoorganizacion = cocoon.request.getParameter("tipoorganizacion");
    var otrotipoorganizacion = cocoon.request.getParameter("otrotipoorganizacion");
    var actividadorganizacion = cocoon.request.getParameter("actividadorganizacion");
    var otraactividadorganizacion = cocoon.request.getParameter("otraactividadorganizacion");
    var pais = cocoon.request.getParameter("pais");
    var estado = cocoon.request.getParameter("estado");
    var usoinformacion = cocoon.request.getParameter("usoinformacion");
    var otrousoinformacion = cocoon.request.getParameter("otrousoinformacion");
    ...
    eperson.setSexo(sexo);
    eperson.setEdad(edad)
    eperson.setEducacion(educacion)
    eperson.setOcupacion(ocupacion)
    eperson.setOtraocupacion(otraocupacion)
    eperson.setOrganizacion(organizacion)
    eperson.setTipoorganizacion(tipoorganizacion)
    eperson.setOtrotipoorganizacion(otrotipoorganizacion)
    eperson.setActividadorganizacion(actividadorganizacion)
    eperson.setOtraactividadorganizacion(otraactividadorganizacion)
    eperson.setPais(pais)
    eperson.setEstado(estado)
    eperson.setUsoinformacion(usoinformacion)
    eperson.setOtrousoinformacion(otrousoinformacion)
