...
public class AddEPersonForm extends AbstractDSpaceTransformer
{
	...
	public void addBody(Body body) throws WingException, SQLException, AuthorizeException 
	{
        ...
        String edadValue = request.getParameter("edad");
        String educacionValue = request.getParameter("educacion");
        String ocupacionValue = request.getParameter("ocupacion");
        String otraocupacionValue = request.getParameter("otraocupacion");
        String organizacionValue = request.getParameter("organizacion");
        String tipoorganizacionValue = request.getParameter("tipoorganizacion");
        String otrotipoorganizacionValue = request.getParameter("otrotipoorganizacion");
        String actividadorganizacionValue = request.getParameter("actividadorganizacion");
        String otraactividadorganizacionValue = request.getParameter("otraactividadorganizacion");
        String paisValue = request.getParameter("pais");
        String estadoValue = request.getParameter("estado");
        String usoinformacionValue = request.getParameter("usoinformacion");
        String otrousoinformacionValue = request.getParameter("otrousoinformacion");
        ...
        Text sexo = identity.addItem().addText("sexo");
        sexo.setLabel(message("Sexo"));
        sexo.setValue(sexoValue);

        Text edad = identity.addItem().addText("edad");
        edad.setLabel(("edad"));
        edad.setValue(edadValue);

        Text educacion = identity.addItem().addText("educacion");
        educacion.setLabel(("educacion"));
        educacion.setValue(educacionValue);

        Text ocupacion = identity.addItem().addText("ocupacion");
        ocupacion.setLabel(("ocupacion"));
        ocupacion.setValue(ocupacionValue);

        Text otraocupacion = identity.addItem().addText("otraocupacion");
        otraocupacion.setLabel(("otraocupacion"));
        otraocupacion.setValue(otraocupacionValue);

        Text organizacion = identity.addItem().addText("organizacion");
        organizacion.setLabel(("organizacion"));
        organizacion.setValue(organizacionValue);

        Text tipoorganizacion = identity.addItem().addText("tipoorganizacion");
        tipoorganizacion.setLabel(("tipoorganizacion"));
        tipoorganizacion.setValue(tipoorganizacionValue);

        Text otrotipoorganizacion = identity.addItem().addText("otrotipoorganizacion");
        otrotipoorganizacion.setLabel(("otrotipoorganizacion"));
        otrotipoorganizacion.setValue(otrotipoorganizacionValue);

        Text actividadorganizacion = identity.addItem().addText("actividadorganizacion");
        actividadorganizacion.setLabel(("actividadorganizacion"));
        actividadorganizacion.setValue(actividadorganizacionValue);

        Text otraactividadorganizacion = identity.addItem().addText("otraactividadorganizacion");
        otraactividadorganizacion.setLabel(("otraactividadorganizacion"));
        ...
        Text usoinformacion = identity.addItem().addText("usoinformacion");
        usoinformacion.setLabel(("usoinformacion"));
        usoinformacion.setValue(usoinformacionValue);

        Text otrousoinformacion = identity.addItem().addText("otrousoinformacion");
        otrousoinformacion.setLabel(("otrousoinformacion"));
